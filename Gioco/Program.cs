       ...
       static void Main(string[] args)
        {
            ...
            giocatore.Nome = Console.ReadLine();
            Console.WriteLine();

            //Controllo sul giocatore
            Partita.ControlloGiocatore(giocatore,listaGiocatori);
            ...
            do 
            {
                ...
                switch (a)
                {
                    case '1':
                        ...
                        //Creo il mostro
                        Mostro mostro = Partita.SceltaMostro(eroe);
                        //Inizia la battaglia
                    ...
                    case '2':
                        ...
                        //eroeservice.CreateEroe(eroe3);
                        break;
                    case '3':
                        List<Eroe> list = eroeservice.GetAllEroi().ToList();
                        Partita.VisualizzaEroi(list,giocatore);
                        ...
                        break;
                    case '4':
                        Partita.VisualizzaStatistiche(listaGiocatori, listaeroi);
                    ...
                    case '5':
                        ...
                        Console.WriteLine("Il Mostro é stato creato, torma al menù");
                        break;
                    default: 
                        x=1;
                        break;
